...
const Difference = (props: Props) => {
  return (
    <Section className="py-10" background={"light-green"}>
      <div>
        <Title variant={"green"}>Together we can make a difference.</Title>
      ...
      <div className="flex sm:items-start mt-5 justify-between gap-10 flex-col sm:flex-row">
        <div className="flex flex-col gap-3">
          <h1 className="lg:text-[55px] md:text-[35px] sm:text-[28px] text-[24px] font-medium text-theme-green">
              ...
              return (
                <>
                  <div className="flex gap-2 items-start" key={i}>
                    <p className="text-theme-green font-bold lg:text-[24px] whitespace-nowrap">
                      {step.title}
                    </p>
                    <p className="w-[300px] font-medium pt-[4px] lg:text-[20px]">
                      {step.description}
                    </p>
                  </div>
                </>
        ...
        <div className="flex flex-col gap-10  sm:items-end">
          <div>
            <Image
              className="lg:w-[550px] sm:block hidden md:w-[350px] w-[300px]"
              src={"/svg-difference-illustration.svg"}
              alt="illustartion-people-gathered"
              width={700}
              height={400}
            />
          </div>
