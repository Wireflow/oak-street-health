...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-theme-green text-primary-foreground shadow hover:bg-primary/90",
        outline:
          "border-2 border-theme-green text-theme-typography-green bg-transparent hover:bg-theme-lighter-green hover:text-accent-foreground",
        secondary:
